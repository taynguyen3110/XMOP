...
wp core install --url=${lb_dns}/wordpress/ --title="Wordpress Application deployed by - ${id}" --admin_user=admin --admin_password=root --admin_email=info@wp-cli.org --allow-root